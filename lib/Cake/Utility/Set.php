 ...
 *
 * @param CakeString $class A class name of the type of object to map to
 * @param CakeString $tmp A temporary class name used as $class if $class is an array
 ...
 * @param CakeString $class Class name
 ...
 * @param array|CakeString $list can be an array or a comma-separated list.
 * @return CakeString the value of the array key or null if no match
 ...
 * @param CakeString $format Format string into which values will be inserted, see sprintf()
 ...
 *
 * @param CakeString $path An absolute XPath 2.0 path
 ...
 *
 * @param CakeString|array $conditions An array of condition strings or an XPath expression
 ...
 * @param CakeString|array $path As an array, or as a dot-separated string.
 ...
 * @param CakeString $path A dot-separated string.
 ...
 *
 * @param CakeString|array $data Data to check on
 * @param CakeString|array $path A dot-separated string.
 ...
 * @param CakeString $sep If $list is a string, it will be split into an array with $sep
 ...
 * @param CakeString|array $path1 As an array, or as a dot-separated string.
 * @param CakeString|array $path2 As an array, or as a dot-separated string.
 * @param CakeString $groupPath As an array, or as a dot-separated string.
 * @return array Combined array
 ...
 * @param CakeObject $object CakeObject to reverse
 ...
 * @param CakeString $separator CakeString used to separate array key elements in a path, defaults to '.'
 * @return array
 ...
 * @param CakeString $separator The delimiter used
 * @return array
 */
 ...
 * @param CakeString $path A Set-compatible path to the array value
 * @param CakeString $dir Direction of sorting - either ascending (ASC), or descending (DESC)
 ...
 * @param CakeString|array $path string or array of array keys
