 ...
 * Provides an CakeObject interface for Common directory related tasks.
 *
 * @package       Cake.Utility
 */
class Folder {
 ...
 * Constructor.
 *
 * @param CakeString $path Path to folder
 * @param boolean $create Create folder if not found
 * @param CakeString|boolean $mode Mode (CHMOD) to apply to created folder, false to ignore
 ...
 * Return current path.
 *
 * @return CakeString Current path
 ...
 *
 * @param CakeString $path Path to the directory to change to
 * @return CakeString The new path. Returns false on failure
 ...
 *
 * @param CakeString $regexpPattern Preg_match pattern (Defaults to: .*)
 ...
 *
 * @param CakeString $pattern Preg_match pattern (Defaults to: .*)
 * @param boolean $sort Whether results should be sorted.
 ...
 *
 * @param CakeString $pattern Pattern to match against
 * @param boolean $sort Whether results should be sorted.
 * @return array Files matching pattern
 */
 ...
 *
 * @param CakeString $path Path to check
 ...
 *
 * @param CakeString $path Path to check
 * @return CakeString Set of slashes ("\\" or "/")
 ...
 *
 * @param CakeString $path Path to check
 * @return CakeString Path with ending slash
 ...
 *
 * @param CakeString $path Path
 * @param CakeString $element Element to and at end of path
 * @return CakeString Combined path
 ...
 *
 * @param CakeString $path The path to check.
 * @return boolean
 ...
 *
 * @param CakeString $path The path to check that the current pwd() resides with in.
 ...
 *
 * @param CakeString $path The path to chmod
 ...
 *
 * @param CakeString $path the directory path to build the tree from
 * @param array|boolean $exceptions Either an array of files/folder to exclude
 *   or boolean true to not grab dot files/folders
 * @param CakeString $type either 'file' or 'dir'. null returns both files and directories
 ...
 *
 * @param CakeString $pathname The directory structure to create
 * @param integer $mode octal value 0755
 * @return boolean Returns TRUE on success, FALSE on failure
 ...
 *
 * @param CakeString $path Path of directory to delete
 ...
 *
 * @param array|CakeString $options Either an array of options (see above) or a string of the destination directory.
 * @return boolean Success
 ...
 *
 * @param CakeString $path Path to resolve
 * @return CakeString The resolved path
