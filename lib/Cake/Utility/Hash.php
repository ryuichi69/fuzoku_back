 ...
 * @param CakeString|array $path The path being searched for. Either a dot
 ...
 * @param CakeString $path The path to extract.
 ...
 *
 * @param CakeString $key The key in the array being searched.
 * @param CakeString $token The token being matched.
 * @return boolean
 */
 ...
 * @param CakeString $selector The patterns to match.
 ...
 * @param CakeString $path The path to insert at.
 ...
 *
 * @param CakeString $op The operation to do.
 ...
 *
 * @param array $data The data to operate on
 * @param CakeString $path A path expression to use to remove.
 ...
 * @param CakeString $keyPath A dot-separated string.
 * @param CakeString $valuePath A dot-separated string.
 * @param CakeString $groupPath A dot-separated string.
 ...
 * @param CakeString $paths An array containing one or more Hash::extract()-style key paths
 ...
 * @param CakeString $path The path to check for.
 ...
 * @param CakeString $path The path to extract for mapping over.
 ...
 * @param CakeString $path The path to extract from $data.
 ...
 * @param CakeString $dir See directions above.
 * @param CakeString $type See direction types above. Defaults to 'regular'.
 ...
 * @param CakeString $key The key for the data.
 * @return array
 */
