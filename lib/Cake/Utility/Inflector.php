 ...
 *
 * @param CakeString $type Inflection type
 * @param CakeString $key Original value
 * @param CakeString $value Inflected value
 * @return CakeString Inflected value, from cache
 */
 ...
 * }}}
 *
 * @param CakeString $type The type of inflection, either 'plural', 'singular' or 'transliteration'
 ...
 *
 * @param CakeString $word Word in singular
 * @return CakeString Word in plural
 ...
 *
 * @param CakeString $word Word in plural
 * @return CakeString Word in singular
 ...
 *
 * @param CakeString $lowerCaseAndUnderscoredWord Word to camelize
 * @return CakeString Camelized word. LikeThis.
 ...
 *
 * @param CakeString $camelCasedWord Camel-cased word to be "underscorized"
 * @return CakeString Underscore-syntaxed version of the $camelCasedWord
 ...
 *
 * @param CakeString $lowerCaseAndUnderscoredWord CakeString to be made more readable
 * @return CakeString Human-readable string
 ...
 *
 * @param CakeString $className Name of class to get database table name for
 * @return CakeString Name of the database table for given class
 ...
 *
 * @param CakeString $tableName Name of database table to get class name for
 * @return CakeString Class name
 ...
 * @return CakeString in variable form
 ...
 *
 * @param CakeString $string the string you want to slug
 * @param CakeString $replacement will replace keys in map
 * @return CakeString
