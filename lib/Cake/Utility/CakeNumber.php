 ...
 * @return CakeString Human readable size
 ...
 * @param float $number A floating point number
 * @param integer $precision The precision of the returned number
 * @return CakeString Percentage string
 ...
 * @return CakeString formatted number
 ...
 * @param CakeString $decimals
 * @param CakeString $thousands
 * @return CakeString
 */
 ...
 *
 * @param float $number
 * @param CakeString $currency Shortcut to default options. Valid values are
 *   'USD', 'EUR', 'GBP', otherwise set at least 'before' and 'after' options.
 * @param array $options
 * @return CakeString Number formatted as a currency.
 ...
 *
 * @param CakeString $formatName The format name to be used in the future.
