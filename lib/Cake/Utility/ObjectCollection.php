 ...
 * a loaded object.
 *
 * @param CakeString $name Name of object to load.
 ...
 *
 *
 * @param CakeString $callback|CakeEvent Method to fire on all the objects. Its assumed all the objects implement
 ...
 *
 * @param CakeString $name Name of property to read
 * @return mixed
 */
 ...
 *
 * @param CakeString $name Name of object being checked.
 * @return boolean
 */
 ...
 *
 * @param CakeString|array $name CamelCased name of the object(s) to enable (string or array)
 ...
 * callable as normal.
 *
 * @param CakeString|array $name CamelCased name of the objects(s) to disable (string or array)
 * @return void
 */
 ...
 *
 * @param CakeString $name Optional.  The name of the object to check the status of.  If omitted,
 ...
 *
 * @param CakeString $name Optional.  The name of the behavior to check the status of.  If omitted,
 ...
 *
 * @param CakeString $name Name of the object to delete.
 * @return void
 */
 ...
 *
 * @param CakeString $name Name of the object
