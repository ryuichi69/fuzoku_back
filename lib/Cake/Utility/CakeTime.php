 ...
 *
 * @param CakeString $format Format with specifiers for strftime function.
 *    Accepts the special specifier %S which mimics the modifier S for date()
 * @param CakeString $time UNIX timestamp
 * @return CakeString windows safe and date() function compatible format for strftime
 ...
 * @return CakeString converted element
 */
 ...
 *
 * @param CakeString $serverTime UNIX timestamp
 * @param CakeString|DateTimeZone $timezone User's timezone string or DateTimeZone object
 ...
 *
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 ...
 *
 * @param integer|CakeString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeString Parsed timestamp
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * @param integer|CakeString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @param CakeString $format The format to use. If null, `TimeHelper::$niceFormat` is used
 * @return CakeString Formatted date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * @param integer|CakeString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeString Described, relative date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|CakeString|DateTime $begin UNIX timestamp, strtotime() valid string or DateTime object
 * @param integer|CakeString|DateTime $end UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeString $fieldName Name of database field to compare with
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeString Partial SQL string.
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * @param integer|CakeString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @param CakeString $format date format string
 ...
 *
 * @param CakeString $dateString Datetime string or Unix timestamp
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeString Formatted date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|CakeString|DateTime $dateTime Datetime UNIX timestamp, strtotime() valid string or DateTime object
 * @param array $options Default format if timestamp is used in $dateString
 * @return CakeString Relative time string.
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param CakeString|integer $timeInterval the numeric value with space then time type.
 ...
 * }}}
 *
 * @param integer|CakeString|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object (or a date format string)
 * @param integer|CakeString|DateTime $format date format string (or UNIX timestamp, strtotime() valid string or DateTime object)
 * @param boolean|CakeString $default if an invalid date is passed it will output supplied default value. Pass false if you want raw conversion value
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeString Formatted date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 ...
 *
 * @param integer|CakeString|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object
 * @param CakeString $format strftime format string.
 * @param boolean|CakeString $default if an invalid date is passed it will output supplied default value. Pass false if you want raw conversion value
 * @param CakeString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return CakeString Formatted and translated date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|CakeString $filter A regex to filter identifer
 * 	Or one of DateTimeZone class constants (PHP 5.3 and above)
 * @param CakeString $country A two-letter ISO 3166-1 compatible country code.
 ...
 *
 * @param CakeString $format Format string.
 * @param integer $date Timestamp to format.
 * @return CakeString formatted string with correct encoding.
 */
