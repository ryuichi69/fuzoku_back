 ...
 * );
 * }}}
 * @param CakeString|array $class as a string or a single key => value array instance will be created,
 ...
 *
 * @param CakeString $key		Key for the object in registry
 * @param CakeObject $object	CakeObject to store
 ...
 *
 * @param CakeString $key	Key of object to remove from registry
 * @return void
 */
 ...
 *
 * @param CakeString $key Key to look for
 ...
 *
 * @param CakeString $key Key of object to look for
 * @return mixed CakeObject stored in registry or boolean false if the object does not exist.
 */
 ...
 *
 * @param CakeString $type Type of object.  If this parameter is omitted, defaults to "Model"
 ...
 *
 * @param CakeString $key Key to include in map
 * @param CakeString $name Key that is being mapped
 * @return void
 */
 ...
 *
 * @param CakeString $key Key to find in map
 * @return CakeString Mapped value
 */
