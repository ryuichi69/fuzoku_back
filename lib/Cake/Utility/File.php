 ...
 * Constructor
 *
 * @param CakeString $path Path to file
 ...
 *
 * @param CakeString $mode A valid 'fopen' mode string (r|w|a ...)
 ...
 *
 * @param CakeString $bytes where to start
 * @param CakeString $mode A `fread` compatible mode.
 * @param boolean $force If true then the file will be re-opened even if its already opened, otherwise it won't
 ...
 *
 * @param CakeString $data Data to prepare for writing.
 * @param boolean $forceWindows
 * @return CakeString The with converted line endings.
 ...
 *
 * @param CakeString $data Data to write to this File.
 * @param CakeString $mode Mode of writing. {@link http://php.net/fwrite See fwrite()}.
 * @param CakeString $force force the file to open
 * @return boolean Success
 ...
 *
 * @param CakeString $data Data to write
 * @param CakeString $force force the file to open
 * @return boolean Success
 ...
 *
 * @return CakeString The File extension
 ...
 *
 * @return CakeString The File name without extension.
 ...
 *
 * @param CakeString $name The name of the file to make safe if different from $this->name
 * @param CakeString $ext The name of the extension to make safe if different from $this->ext
 * @return CakeString $ext the extension of the file
 ...
 * @return CakeString md5 Checksum {@link http://php.net/md5_file See md5_file()}
 ...
 *
 * @return CakeString Full path to file
 ...
 *
 * @return CakeString Permissions for the file
 ...
 *
 * @param CakeString $dest destination for the copy
 ...
 *
 * @return false|CakeString The mimetype of the file, or false if reading fails.
 */
