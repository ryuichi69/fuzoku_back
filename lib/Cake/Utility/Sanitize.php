 ...
 *
 * @param CakeString $string CakeString to sanitize
 * @param array $allowed An array of additional characters that are not to be removed.
 * @return CakeString Sanitized string
 */
 ...
 *
 * @param CakeString $string CakeString to sanitize
 * @param CakeString $connection Database connection being used
 * @return CakeString SQL safe string
 */
 ...
 *
 * @param CakeString $string CakeString from where to strip tags
 ...
 *
 * @param CakeString $str CakeString to sanitize
 * @return CakeString whitespace sanitized string
 */
 ...
 *
 * @param CakeString $str CakeString to sanitize
 * @return CakeString Sting with images stripped.
 */
 ...
 *
 * @param CakeString $str CakeString to sanitize
 * @return CakeString CakeString with <script>, <style>, <link>, <img> elements removed.
 */
 ...
 *
 * @param CakeString $str,... CakeString to sanitize
 * @return CakeString sanitized CakeString
 */
 ...
 *
 * @param CakeString|array $data Data to sanitize
 * @param CakeString|array $options If string, DB connection being used, otherwise set of options
