 ...
 *
 * @param CakeString $data The data to tokenize
 * @param CakeString $separator The token to split the data on.
 * @param CakeString $leftBound The left boundary to ignore separators in.
 * @param CakeString $rightBound The right boundary to ignore separators in.
 ...
 *
 * @param CakeString $str A string containing variable placeholders
 * @param CakeString $data A key => val array where each key stands for a placeholder variable name
 *     to be replaced with val
 * @param CakeString $options An array of options, see description above
 * @return CakeString
 */
 ...
 *
 * @param CakeString $str
 * @param CakeString $options
 * @return CakeString
 ...
 * - `indent` CakeString to indent with. Defaults to null.
 ...
 * @return CakeString Formatted text.
 */
 ...
 *
 * @param CakeString $text Text to search the phrase in
 * @param CakeString $phrase The phrase that will be searched
 * @param array $options An array of html attributes and options.
 * @return CakeString The highlighted text
 ...
 *
 * @param CakeString $text Text
 * @return CakeString The text without links
 ...
 *
 * @param CakeString $text CakeString to truncate.
 * @param integer $length Length of returned string, including ellipsis.
 * @param array $options An array of html attributes and options.
 * @return CakeString Trimmed string.
 ...
 *
 * @param CakeString $text CakeString to search the phrase in
 * @param CakeString $phrase Phrase that will be searched for
 * @param integer $radius The amount of characters that will be returned on each side of the founded phrase
 * @param CakeString $ending Ending that will be appended
 * @return CakeString Modified string
 ...
 * @param CakeString $and The word used to join the last and second last items together with. Defaults to 'and'
 * @param CakeString $separator The separator used to join all the other items together. Defaults to ', '
 * @return CakeString The glued together string.
