 ...
 *
 * @param CakeString|array $input XML string, a path to a file, an URL or an array
 ...
 *
 * @param CakeString $input The input to load.
 ...
 * @param CakeString $format Either 'attribute' or 'tags'.  This determines where nested keys go.
 * @return void
 * @throws XmlException
 */
 ...
 * @param CakeString $ns Namespace of current child
