 ...
 *
 * @param CakeString $authKey Authorization hash
 ...
 *
 * @param CakeString $string CakeString to hash
 * @param CakeString $type Method to use (sha1/sha256/md5)
 ...
 * Security::hash().
 *
 * @param CakeString $hash Method to use (sha1/sha256/md5)
 * @return void
 * @see Security::hash()
 */
 ...
 *
 * @param CakeString $text Encrypted string to decrypt, normal string to encrypt
 * @param CakeString $key Key to use
 * @return CakeString Encrypted/Decrypted string
 */
 ...
 * @param CakeString $text Encrypted string to decrypt, normal string to encrypt
 * @param CakeString $key Key to use
 * @param CakeString $operation Operation to perform, encrypt or decrypt
 * @return CakeString Encrypted/Descrypted string
 */
