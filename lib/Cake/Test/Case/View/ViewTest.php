 ...
 */
	public function testLoadHelpers() {
		...
		$this->assertInstanceOf('HtmlHelper', $View->Html, 'CakeObject type is wrong.');
		$this->assertInstanceOf('FormHelper', $View->Form, 'CakeObject type is wrong.');
	}
