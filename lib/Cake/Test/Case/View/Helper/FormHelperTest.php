 ...
 * name property
 *
 * @var CakeString 'ContactNonStandardPk'
 */
 ...
 * name property
 *
 * @var CakeString 'ValidateProfile'
 */
 ...
 */
	public function testInput() {
		...
		$result = $this->Form->input('CakeObject.field', array('after' => 'A message to you, Rudy'));
		$expected = array(
			'div' => array('class' => 'input text'),
			'label' => array('for' => 'ObjectField'),
			'Field',
			'/label',
			'input' => array('type' => 'text', 'name' => 'data[CakeObject][field]', 'id' => 'ObjectField'),
			'A message to you, Rudy',
			'/div'
		);
		$this->assertTags($result, $expected);
