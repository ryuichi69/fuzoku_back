 ...
 */
	public function testReadEmpty() {
		...
		$this->assertEquals('{"somewhat:"broken"}', $this->Cookie->read('CakeString'));
	}
 ...
 * @return CakeString CakeString in the form key1|value1,key2|value2
 */
