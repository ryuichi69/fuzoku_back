...
App::uses('PhpAclCake', 'Controller/Component/Acl');
class_exists('AclComponent');

/**
 * Test case for the PhpAclCake implementation
 *
 * @package       Cake.Test.Case.Controller.Component.Acl
 */
class PhpAclTest extends CakeTestCase {
	...
	public function setUp() {
		parent::setUp();
		Configure::write('Acl.classname', 'PhpAclCake');
		$Collection = new ComponentCollection();
		$this->PhpAcl = new PhpAclCake();
 ...
 */
	public function testPolicy() {
		// allow by default
		$this->Acl->settings['adapter']['policy'] = PhpAclCake::ALLOW;
