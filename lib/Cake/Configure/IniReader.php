 ...
 *
 * @param CakeString $path Path to load ini config files from.
 * @param CakeString $section Only get one section, leave null to parse and fetch
 ...
 *
 * @param CakeString $key The identifier to read from. If the key has a . it will be treated
 ...
 *
 * @param CakeString $filename The filename on $this->_path to save into.
 ...
 * @return CakeString CakeString value for ini file.
 */
