 ...
 *
 * @param CakeString $viewFile The view file
 */
 ...
 *
 * @param CakeString $name The name of the function
 ...
 *
 * @param CakeString $url The url to test
 ...
 *
 * @param CakeString $controller Controller name
