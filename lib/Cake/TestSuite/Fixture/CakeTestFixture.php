 ...
 *
 * @param CakeObject	$db	An instance of the database object used to create the fixture table
 ...
 *
 * @param CakeObject $db An instance of the database into which the records will be inserted
 ...
 * truncate.
 *
 * @param CakeObject $db A reference to a db instance
 * @return boolean
 */
