 ...
 *
 * @param CakeString $model Optional model name.  Uses the default if none is specified.
 ...
 *
 * @param array|CakeString $options Default options for pagination links. If a string is supplied - it
 ...
 *
 * @param CakeString $model Optional model name.  Uses the default if none is specified.
 * @return CakeString The current page number of the recordset.
 ...
 * @return CakeString The name of the key by which the recordset is being sorted, or
 ...
 * @param CakeString $model Optional model name.  Uses the default if none is specified.
 * @param array $options Options for pagination links. See #options for list of keys.
 * @return CakeString The direction by which the recordset is being sorted, or
 *  null if the results are not currently sorted.
 ...
 *
 * @param CakeString $title Title for the link. Defaults to '<< Previous'.
 * @param array $options Options for pagination link. See #options for list of keys.
 * @param CakeString $disabledTitle Title when the link is disabled.
 * @param array $disabledOptions Options for the disabled pagination link. See #options for list of keys.
 * @return CakeString A "previous" link or $disabledTitle text if the link is disabled.
 ...
 * - `model` The model to use, defaults to PaginatorHelper::defaultModel()
 *
 * @param CakeString $title Title for the link. Defaults to 'Next >>'.
 ...
 * @return CakeString A "next" link or or $disabledTitle text if the link is disabled.
 ...
 *
 * @param CakeString $key The name of the key that the recordset should be sorted.
 * @param CakeString $title Title for the link. If $title is null $key will be used
 *		for the title and will be generated by inflection.
 * @param array $options Options for sorting link. See above for list of keys.
 * @return CakeString A link sorting default by 'asc'. If the resultset is sorted 'asc' by the specified
 ...
 * - `model` The model to use, defaults to PaginatorHelper::defaultModel()
 *
 * @param CakeString $title Title for the link.
 * @param CakeString|array $url Url for the action. See Router::url()
 * @param array $options Options for the link. See #options for list of keys.
 * @return CakeString A link with pagination parameters.
 ...
 * @param CakeString $model Which model to paginate on
 ...
 *
 * @param CakeString $which
 * @param CakeString $title
 * @param array $options
 * @param CakeString $disabledTitle
 ...
 *
 * @param CakeString $model Model name to get parameters for.
 ...
 *
 * @return CakeString Model name or null if the pagination isn't initialized.
 ...
 * @return CakeString Counter string.
 ...
 * @return CakeString numbers string.
 ...
 *
 * @param CakeString|integer $first if string use as label for the link. If numeric, the number of page links
 ...
 * - `ellipsis` Content for ellipsis, defaults to '...'
 *
 * @param CakeString|integer $last if string use as label for the link, if numeric print page numbers
