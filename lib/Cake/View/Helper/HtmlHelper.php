 ...
 *
 * @param CakeString $name Text for link
 * @param CakeString $link URL for link (if empty it won't be a link)
 * @param CakeString|array $options Link attributes e.g. array('id' => 'selected')
 * @return void
 ...
 *  - xhtml11: XHTML1.1.
 *
 * @param CakeString $type Doctype to use.
 * @return CakeString Doctype string
 ...
 *
 * @param CakeString $type The title of the external resource
 * @param CakeString|array $url The address of the external resource or string for content attribute
 * @param array $options Other attributes for the generated tag. If the type attribute is html,
 *    rss, atom, or icon, the mime-type is returned.
 * @return CakeString A completed `<link />` element.
 ...
 *
 * @param CakeString $charset The character set to be used in the meta tag. If empty,
 *  The App.encoding value will be used. Example: "utf-8".
 * @return CakeString A meta tag containing the specified character set.
 ...
 *
 * @param CakeString $title The content to be wrapped by <a> tags.
 * @param CakeString|array $url Cake-relative URL or array of URL parameters, or external URL (starts with http://)
 * @param array $options Array of HTML attributes.
 * @param CakeString $confirmMessage JavaScript confirmation message.
 * @return CakeString An `<a />` element.
 ...
 *
 * @param CakeString|array $path The name of a CSS style sheet or an array containing names of
 *   CSS stylesheets. If `$path` is prefixed with '/', the path will be relative to the webroot
 *   of your application. Otherwise, the path will be relative to your CSS path, usually webroot/css.
 * @param CakeString $rel Rel attribute. Defaults to "stylesheet". If equal to 'import' the stylesheet will be imported.
 * @param array $options Array of HTML attributes.
 * @return CakeString CSS <link /> or <style /> tag, depending on the type of link.
 ...
 * - `plugin` False value will prevent parsing path as a plugin
 *
 * @param CakeString|array $url CakeString or array of javascript files to include
 * @param array|boolean $options Array of options, and html attributes see above. If boolean sets $options['inline'] = value
 * @return mixed CakeString of `<script />` tags or null if $inline is false or if $once is true and the file has been
 *   included before.
 ...
 *   Defaults to `script`.
 *
 * @param CakeString $script The script to wrap
 ...
 * @return CakeString CSS styling data
 ...
 *
 * @param CakeString $separator Text to separate crumbs.
 * @param CakeString|array|boolean $startText This will be the first crumb, if false it defaults to first crumb in array. Can
 *   also be an array, see above for details.
 * @return CakeString Composed bread crumbs
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 * @return CakeString breadcrumbs html list
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 * - `plugin` False value will prevent parsing path as a plugin
 *
 * @param CakeString $path Path to the image file, relative to the app/webroot/img/ directory.
 * @param array $options Array of HTML attributes.  See above for special options.
 * @return CakeString completed img tag
 ...
 * @return CakeString Completed table headers
 ...
 * @return CakeString Formatted HTML
 ...
 *
 * @param CakeString $name Tag name.
 * @param CakeString $text CakeString content that will appear inside the div element.
 *   If null, only a start tag will be printed
 * @param array $options Additional HTML attributes of the DIV tag, see above.
 * @return CakeString The formatted tag element
 ...
 *
 * @param CakeString $tag Tag name
 * @return CakeString Formatted block
 ...
 * - `escape` Whether or not the contents should be html_entity escaped.
 *
 * @param CakeString $class CSS class name of the div element.
 * @param CakeString $text CakeString content that will appear inside the div element.
 *   If null, only a start tag will be printed
 * @param array $options Additional HTML attributes of the DIV tag
 * @return CakeString The formatted DIV element
 ...
 * - `escape` Whether or not the contents should be html_entity escaped.
 *
 * @param CakeString $class CSS class name of the p element.
 * @param CakeString $text CakeString content that will appear inside the p element.
 * @param array $options Additional HTML attributes of the P tag
 * @return CakeString The formatted P element
 ...
 *
 * @param CakeString|array $path Path to the video file, relative to the webroot/{$options['pathPrefix']} directory.
 *  Or an array where each item itself can be a path string or an associate array containing keys `src` and `type`
 * @param array $options Array of HTML attributes, and special options above.
 * @return CakeString Generated media element
 */
 ...
 * @param CakeString $tag Type of list tag to use (ol/ul)
 * @return CakeString The nested list
 ...
 * @param array $itemOptions Additional HTML attributes of the list item (LI) tag
 * @param CakeString $tag Type of list tag to use (ol/ul)
 * @return CakeString The nested list element
 ...
 *
 * @param CakeString|array $configFile CakeString with the config file (load using PhpReader) or an array with file and reader name
 * @param CakeString $path Path with config file
