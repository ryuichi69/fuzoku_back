 ...
 *
 * @param CakeString $name Name of the attribute to set.
 * @param CakeString $value Value of the attribute to set.
 * @return mixed
 */
 ...
 *
 * @param CakeString $name Name of the attribute to check.
 * @return boolean
 */
 ...
 *
 * @param CakeString $name Name of the attribute to get.
 * @return mixed
 */
...
/**
 * @param integer|CakeString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime objectp
 * @param CakeString|DateTimeZone $timezone User's timezone string or DateTimeZone object
...
/**
 * @param integer|CakeString|DateTime $dateTime UNIX timestamp, strtotime() valid string or DateTime object
...
/**
 * @param integer|CakeString|DateTime $string UNIX timestamp, strtotime() valid string or DateTime object
 * @return integer UNIX timestamp
 * @see CakeTime::gmt()
 *
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
...
/**
 * @param integer|CakeString|DateTime $format date format string (or a UNIX timestamp, strtotime() valid string or DateTime object)
