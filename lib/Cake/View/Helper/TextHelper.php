 ...
 * @return CakeString The text with links
 ...
 * @return CakeString Replaced values.
 */
 ...
 *
 * @param CakeString $text The text to operate on.
 * @param array $htmlOptions The options for the generated links.
 * @return CakeString The text with links inserted.
 */
...
/**
 * @param CakeString $text String to truncate.
...
/**
 * @param CakeString $text String to search the phrase in
