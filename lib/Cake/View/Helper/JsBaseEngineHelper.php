 ...
 *
 * @param CakeString $message Message you want to alter.
 * @return CakeString completed alert()
 */
 ...
 *
 * @param CakeString|array $url
 * @param array  $options
 * @return CakeString completed redirect in javascript
 */
 ...
 *
 * @param CakeString $message Message you want confirmed.
 * @return CakeString completed confirm()
 */
 ...
 * function scope.
 *
 * @param CakeString $message Message to use in the confirm dialog.
 * @return CakeString completed confirm with return script
 */
 ...
 *
 * @param CakeString $message Message you want to prompt.
 * @param CakeString $default Default message
 * @return CakeString completed prompt()
 */
...
/**
 * Generates a JavaScript object in JavaScript CakeObject Notation (JSON)
 * from an array.  Will use native JSON encode method if available, and $useNative == true
 *
 * ### Options:
 *
 * - `prefix` - CakeString prepended to the returned data.
 * - `postfix` - CakeString appended to the returned data.
 *
 * @param array $data Data to be converted.
 * @param array $options Set of options, see above.
 * @return CakeString A JSON code block
 */
 ...
 * @return CakeString a JavaScript-safe/JSON representation of $val
 */
 ...
 * - '"' => '\"'
 *
 * @param CakeString $string CakeString that needs to get escaped.
 * @return CakeString Escaped string.
 */
 ...
 *
 * @param CakeString $string The string that needs to be utf8->hex encoded
 * @return void
 */
 ...
 *
 * @param CakeString $selector The selector that is targeted
 ...
 *
 * @param CakeString $type Type of event to bind to the current dom id
 * @param CakeString $callback The Javascript function you wish to trigger or the function literal
 * @param array $options Options for the event.
 * @return CakeString completed event handler
 */
 ...
 *
 * @param CakeString $functionBody The code to run on domReady
 * @return CakeString completed domReady method
 */
 ...
 *
 * @param CakeString $callback The function body you wish to apply during the iteration.
 * @return CakeString completed iteration
 */
 ...
 *   the speed option.
 *
 * @param CakeString $name The name of the effect to trigger.
 * @param array $options Array of options for the effect.
 * @return CakeString completed string with effect.
 */
 ...
 *
 * @param CakeString|array $url Array or CakeString URL to target with the request.
 * @param array $options Array of options. See above for cross library supported options
 * @return CakeString XHR request.
 */
 ...
 * @return CakeString Completed drag script
 */
 ...
 * @return CakeString Completed drop script
 */
 ...
 * @return CakeString Completed sortable script.
 */
 ...
 * @return CakeString Completed slider script
 */
 ...
 * @return CakeString completed form serialization script
 */
 ...
 * @return CakeString Parsed JSON options without enclosing { }.
 */
 ...
 *
 * @param CakeString $method Name of method whose options are being worked with.
 ...
 * _callbackArgs array.
 *
 * @param CakeString $method Name of the method you are preparing callbacks for.
 ...
 *
 * @param CakeString $method Name of method processing options for.
 * @param array $options Array of options to process.
 * @return CakeString Parsed options string.
 */
 ...
 * @return CakeString Querystring fragment
 */
