 ...
 * @param CakeString $content
 * @return CakeString An RSS document
 ...
 * @param CakeString $content Content (`<item />`'s belonging to this channel
 * @return CakeString An RSS `<channel />`
 ...
 * @param CakeString|array $callback A string function name, or array containing an object
 *     and a string method name
 * @return CakeString A set of RSS `<item />` elements
 ...
 * @return CakeString An RSS `<item />` element
 ...
 *
 * @param integer|CakeString|DateTime $time
 * @return CakeString An RSS-formatted timestamp
 ...
 *
 * @param CakeString $name The name of the XML element
 * @param array $attrib The attributes of the XML element
 * @param CakeString|array $content XML element content
 * @param boolean $endTag Whether the end tag of the element should be printed
 * @return CakeString XML
