 ...
 *
 * @param CakeString $file The filename to process.
 * @param CakeString $out The output for the file.
 * @return CakeString Updated content.
 */
 ...
 *
 * @param CakeString $file File to cache
 * @param CakeString $out output to cache
 * @return CakeString view ouput
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/cache.html
 */
 ...
 *
 * @param CakeString $file The filename that needs to be parsed.
 * @param CakeString $cache The cached content
 * @return void
 */
 ...
 *
 * @return CakeString The content with cake:nocache tags replaced.
 */
 ...
 *
 * @param CakeString $content CakeString to remove tags from.
 * @return CakeString CakeString with tags removed.
 */
 ...
 *
 * @param CakeString $cache Output to replace content in.
 * @return CakeString with all replacements made to <!--nocache--><!--nocache-->
 */
 ...
 *
 * @param CakeString $content view content to write to a cache file.
 * @param CakeString $timestamp Duration to set for cache file.
