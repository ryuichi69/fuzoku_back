 ...
 *
 * @param CakeString $method Method to invoke
 ...
 *
 * @param CakeString $name Name of the property being accessed.
 ...
 *
 * @param CakeString|array $url Either a relative string url like `/products/view/23` or
 *    an array of url parameters.  Using an array for urls will allow you to leverage
 *    the reverse routing features of CakePHP.
 * @param boolean $full If true, the full base URL will be prepended to the result
 * @return CakeString  Full translated URL with base path.
 ...
 *
 * @param CakeString $file The file to create a webroot path to.
 * @return CakeString Web accessible path to file.
 */
 ...
 *
 * @param CakeString|array Path string or url array
 * @param array $options Options array. Possible keys:
 *   `fullBase` Return full url with domain name
 *   `pathPrefix` Path prefix for relative urls
 *   `ext` Asset extension to append
 *   `plugin` False value will prevent parsing path as a plugin
 * @return CakeString Generated url
 */
 ...
 *
 * @param CakeString $path The file path to timestamp, the path must be inside WWW_ROOT
 * @return CakeString Path with a timestamp added, or not.
 */
 ...
 *
 * @param CakeString|array $output Either an array of strings to clean or a single string to clean.
 * @return CakeString|array cleaned content for output
 */
 ...
 * @param CakeString $insertBefore CakeString to be inserted before options.
 * @param CakeString $insertAfter CakeString to be inserted after options.
 * @return CakeString Composed attributes.
 ...
 *
 * @param CakeString $key The name of the attribute to create
 * @param CakeString $value The value of the attribute to create.
 * @param boolean $escape Define if the value must be escaped
 * @return CakeString The composed attribute.
 * @deprecated This method will be moved to HtmlHelper in 3.0
 */
 ...
 *
 * @param CakeString $entity A field name, like "ModelName.fieldName" or "ModelName.ID.fieldName"
 ...
 *
 * @param array|CakeString $options Either an array of html attributes to add $id into, or a string
 *   with a view entity path to get a domId for.
 * @param CakeString $id The name of the 'id' attribute.
 ...
 *
 * @param array|CakeString $options If an array, should be an array of attributes that $key needs to be added to.
 *   If a string or null, will be used as the View entity.
 * @param CakeString $field
 * @param CakeString $key The name of the attribute to be set, defaults to 'name'
 ...
 *   If a string or null, will be used as the View entity.
 * @param CakeString $field
 * @param CakeString $key The name of the attribute to be set, defaults to 'value'
 * @return mixed If an array was given for $options, an array with $key set will be returned.
 *   If a string was supplied a string will be returned.
 * @todo Refactor this method to not have as many input/output options.
 */
 ...
 *
 * @param CakeString $field The field name to initialize.
 ...
 * @param CakeString $class The classname being added.
 * @param CakeString $key the key to use for class.
 ...
 *
 * @param CakeString $str CakeString to be output.
 * @return CakeString
 ...
 *
 * @param CakeString $viewFile The view file that is going to be rendered
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeString $viewFile The view file that was rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeString $layoutFile The layout about to be rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeString $layoutFile The layout file that was rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeString $viewFile The file about to be rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param CakeString $viewFile The file just be rendered.
 * @param CakeString $content The content that was rendered.
 * @return void
 */
