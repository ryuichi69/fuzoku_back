 ...
 *
 * @var CakeString Name of controller
 */
	public $name = null;
 ...
 *
 * @param CakeString $name Name of template file in the/app/View/Elements/ folder,
 ...
 *   Defaults to false.
 * @return CakeString Rendered Element
 ...
 *
 * @param CakeString $view Name of view file to use
 * @param CakeString $layout Layout to use.
 * @return CakeString Rendered Element
 ...
 *
 * @param CakeString $content Content to render in a view, wrapped by the surrounding layout.
 * @param CakeString $layout Layout name
 ...
 *
 * @param CakeString $filename the cache file to include
 * @param CakeString $timeStart the page render start time
 ...
 *
 * @param CakeString $var The view var you want the contents of.
 ...
 *
 * @param CakeString $name The name of the block to capture for.
 * @return void
 * @see ViewBlock::start()
 */
 ...
 *
 * @param CakeString $name Name of the block
 * @param CakeString $value The content for the block.
 * @return void
 ...
 *
 * @param CakeString $name The view or element to 'extend' the current one with.
 * @return void
 ...
 *
 * @param CakeString $name Either the key name for the script, or the script content. Name can be used to
 *   update/replace a script element.
 * @param CakeString $content The content of the script being added, optional.
 * @return void
 ...
 *
 * @param CakeString $object Type of object, i.e. 'form' or 'link'
 * @param CakeString $url The object's target URL
 * @return CakeString
 */
 ...
 *
 * @param CakeString|array $one A string or an array of data.
 * @param CakeString|array $two Value in case $one is a string (which then works as the key).
 ...
 *
 * @param CakeString $viewFile Filename of the view
 * @param array $data Data to include in rendered view. If empty the current View::$viewVars will be used.
 * @return CakeString Rendered output
 ...
 *
 * @param CakeString $viewFn Filename of the view
 ...
 *
 * @param CakeString $helperName Name of the helper to load.
 ...
 *
 * @param CakeString $name Controller action to find template filename for
 * @return CakeString Template filename
 ...
 *
 * @param CakeString $name The name you want to plugin split.
 ...
 *
 * @param CakeString $name The name of the layout to find.
 * @return CakeString Filename for layout file (.ctp).
 ...
 *
 * @param CakeString $name The name of the element to find.
 ...
 *
 * @param CakeString $plugin Optional plugin name to scan for view files.
