 ...
 * Constructor.
 *
 * @param CakeString $base The base directory for the application. Writes `App.base` to Configure.
 */
 ...
 * @return CakeString|void if `$request['return']` is set then it returns response body, null otherwise
 ...
 * @return CakeString|bool Name of controller class name
 */
