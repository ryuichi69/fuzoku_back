 ...
 *
 * @param CakeString $routeClass to set as default
 ...
 *
 * @param CakeString $route A string describing the template of the route
 ...
 *
 * @param CakeString|array $controller A controller name or array of controller names (i.e. "Posts" or "ListItems")
 ...
 *
 * @param CakeString $url URL to be parsed
 ...
 *
 * @param CakeString|array $url Cake-relative URL, like "/products/edit/92" or "/presidents/elect/4"
 ...
 * @return CakeString A generated url for the array
 * @see Router::url()
 */
 ...
 *
 * @param CakeString|array $q Query string Either a string of already compiled query string arguments or
 ...
 *     the url.
 * @return CakeString The string that is the reversed result of the array
 */
 ...
 * of the input value.
 *
 * @param array|CakeString $url URL to normalize Either an array or a string url.
 * @return CakeString Normalized URL
 */
 ...
 *
 * @param CakeString $base Base URL
 * @param CakeString $plugin Plugin name
 * @return CakeString base url with plugin name removed if present
 */
