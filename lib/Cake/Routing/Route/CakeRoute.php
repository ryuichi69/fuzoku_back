 ...
 *
 * @param CakeString $template Template string with parameter placeholders
 ...
 * false will be returned. CakeString urls are parsed if they match a routes regular expression.
 *
 * @param CakeString $url The url to attempt to parse.
 ...
 *
 * @param CakeString $args A string with the passed & named params.  eg. /1/page:2
 * @param CakeString $context The current route context, which should contain controller/action keys.
 ...
 *
 * @param CakeString $val The value of the named parameter
 * @param array $rule The rule(s) to apply, can also be a match string
 * @param CakeString $context An array with additional context information (controller / action)
 * @return boolean
 */
 ...
 * @return CakeString Composed route string.
 */
