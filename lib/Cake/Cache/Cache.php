 ...
 *
 * @param CakeString $name Name of the configuration
 ...
 *
 * @param CakeString $name Name of the config array that needs an engine instance built
 * @return boolean
 * @throws CacheException
 */
 ...
 *
 * @param CakeString $name A currently configured cache config you wish to remove.
 ...
 *
 * @param CakeString|array $settings Optional string for simple name-value pair or array
 * @param CakeString $value Optional for a simple name-value pair
 * @param CakeString $config The configuration name you are changing. Defaults to 'default'
 ...
 *
 * @param CakeString $config [optional] The config name you wish to have garbage collected. Defaults to 'default'
 ...
 *
 * @param CakeString $key Identifier for the data
 * @param mixed $value Data to be cached - anything except a resource
 * @param CakeString $config Optional string configuration name to write to. Defaults to 'default'
 ...
 *
 * @param CakeString $key Identifier for the data
 * @param CakeString $config optional name of the configuration to use. Defaults to 'default'
 ...
 * @param CakeString $config Optional string configuration name. Defaults to 'default'
 ...
 *
 * @param CakeString $key Identifier for the data
 * @param CakeString $config name of the configuration to use. Defaults to 'default'
 ...
 *
 * @param CakeString $group name of the group to be cleared
 * @param CakeString $config name of the configuration to use. Defaults to 'default'
 ...
 *
 * @param CakeString $name Name of the configuration to get settings for. Defaults to 'default'
