 ...
 * Constructor
 *
 * @param CakeString $message If no message is given 'Bad Request' will be the message
 * @param CakeString $code Status code, defaults to 400
 */
 ...
 * Constructor
 *
 * @param CakeString $message If no message is given 'Unauthorized' will be the message
 * @param CakeString $code Status code, defaults to 401
 */
 ...
 * Constructor
 *
 * @param CakeString $message If no message is given 'Forbidden' will be the message
 * @param CakeString $code Status code, defaults to 403
 */
 ...
 * Constructor
 *
 * @param CakeString $message If no message is given 'Not Found' will be the message
 * @param CakeString $code Status code, defaults to 404
 */
 ...
 * Constructor
 *
 * @param CakeString $message If no message is given 'Method Not Allowed' will be the message
 * @param CakeString $code Status code, defaults to 405
 */
 ...
 * Constructor
 *
 * @param CakeString $message If no message is given 'Internal Server Error' will be the message
 * @param CakeString $code Status code, defaults to 500
 */
 ...
 * when debug = 0.
 *
 * @param CakeString|array $message Either the string of the error message, or an array of attributes
 *   that are made available in the view, and sprintf()'d into CakeException::$_messageTemplate
 * @param CakeString $code The code of the error, is also the HTTP status code for the error.
 */
 ...
 * Constructor
 *
 * @param CakeString $message
 * @param integer $code
 * @param CakeString $file
 * @param integer $line
 */
