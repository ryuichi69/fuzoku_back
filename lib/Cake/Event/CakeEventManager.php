 ...
 *
 * @param CakeString $eventKey The event unique identifier name to with the callback will be associated. If $callable
 ...
 * @param CakeString $eventKey optional event key name to unsubscribe the listener from
 * @return void
 */
 ...
 *
 * @param CakeString|CakeEvent $event the event key name or instance of CakeEvent
 * @return void
 */
