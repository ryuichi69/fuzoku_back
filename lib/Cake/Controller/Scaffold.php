 ...
 *
 * @param CakeRequest $request Request CakeObject for scaffolding
 ...
 *
 * @param CakeString $action Action (add or edit)
 ...
 *
 * @param CakeRequest $request Request CakeObject for scaffolding
 * @param CakeString $action add or edit
 ...
 *
 * @param CakeString $message Message to display
 * @return void
 */
