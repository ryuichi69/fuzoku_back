 ...
 *
 * @param CakeString $modelClass Name of model class to load
 * @param integer|CakeString $id Initial ID the instanced model class should have
 ...
 *
 * @param CakeString|array $url A string or array-based URL pointing to another location within the app,
 *     or an absolute URL
 ...
 * @param CakeString|array $url The same value of beforeRedirect
 ...
 *
 * @param CakeString $status The header message that is being set.
 * @return void
 ...
 * }}}
 *
 * @param CakeString $action The new action to be 'redirected' to
 ...
 *
 * @param CakeString $view View to use for rendering
 ...
 *
 * @param CakeString $default Default URL to use if HTTP_REFERER cannot be read from headers
 * @param boolean $local If true, restrict referring URLs to local server
 * @return CakeString Referring URL
 ...
 *
 * @param CakeString $message Message to display to the user
 * @param CakeString|array $url Relative string or array-based URL to redirect to after the time expires
 * @param integer $pause Time to show the message
 * @param CakeString $layout Layout you want to use, defaults to 'flash'
 ...
 * @param CakeString|array $op A string containing an SQL comparison operator, or an array matching operators
 *        to fields
 * @param CakeString $bool SQL boolean operator: AND, OR, XOR, etc.
 ...
 *
 * @param Model|CakeString $object Model to paginate (e.g: model instance, or 'Model', or 'Model.InnerModel')
 * @param CakeString|array $scope Conditions to use while paginating
 ...
 *
 * @param CakeString $method name of method called example index, edit, etc.
 ...
 * This method should be overridden in child classes.
 *
 * @param CakeString $method name of method called either edit or update.
 * @return boolean Success
 * @link http://book.cakephp.org/2.0/en/controllers.html#callbacks
 */
