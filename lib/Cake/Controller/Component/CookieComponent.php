 ...
 *
 * @param CakeString|array $key Key for the value
 * @param mixed $value Value
 * @param boolean $encrypt Set to true to encrypt value, false otherwise
 * @param integer|CakeString $expires Can be either Unix timestamp, or date string
 * @return void
 ...
 *
 * @param CakeString $key Key of the value to be obtained. If none specified, obtain map key => values
 * @return CakeString or null, value for specified key
 ...
 * Failure to do so will result in header already sent errors.
 *
 * @param CakeString $key Key of the value to be deleted
 * @return void
 ...
 * written any cookies.
 *
 * @param CakeString $type Encryption method
 * @return void
 */
 ...
 * Set cookie
 *
 * @param CakeString $name Name for cookie
 * @param CakeString $value Value for cookie
 * @return void
 */
 ...
 *
 * @param CakeString $name Name of cookie
 * @return void
 */
 ...
 *
 * @param CakeString $value Value to encrypt
 * @return CakeString encrypted string
 * @return CakeString Encoded values
 */
 ...
 * @return CakeString decrypted string
 */
 ...
 * @return CakeString A json encoded string.
 */
 ...
 *
 * @param CakeString $string A string containing JSON encoded data, or a bare string.
