 ...
 * @param CakeString|array $scope Additional find conditions to use while paginating
 ...
 *
 * @param CakeString|Model $object The object you are looking for.
 ...
 *
 * @param CakeString $alias Model alias being paginated, if the general settings has a key with this value
 ...
 * will be used.
 *
 * @param CakeString $alias Model name to get default settings for.
