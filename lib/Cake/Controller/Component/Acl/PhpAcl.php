...
/**
 * PhpAclCake implements an access control system using a plain PHP configuration file.
 * An example file can be found in app/Config/acl.php
 *
 * @package Cake.Controller.Component.Acl
 */
class PhpAclCake extends CakeObject implements AclInterface {
...
/**
 * No op method, allow cannot be done with PhpAclCake
 *
 * @param CakeString $aro ARO The requesting object identifier.
 * @param CakeString $aco ACO The controlled object identifier.
 * @param CakeString $action Action (defaults to *)
 ...
 *
 * @param CakeString $aro ARO
 * @param CakeString $aco ACO
 * @param CakeString $action Action
 ...
 *
 * @param CakeString $aco ACO string
 * @return array path
 */
 ...
 *
 * is passed as an ARO to one of the methods of AclComponent, PhpAclCake
 ...
 * 
 * @param CakeString|array $aro An ARO identifier
 ...
 *
 * @param CakeString|array $aro ARO identifier (User.jeff, array('User' => ...), etc)
 * @return CakeString internal aro string (e.g. User/jeff, Role/default)
 */
