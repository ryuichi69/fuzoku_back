 ...
 *
 * @param AclInterface|CakeString $adapter Instance of AclInterface or a string name of the class to use. (optional)
 ...
 *
 * @param array|CakeString|Model $aro ARO The requesting object identifier. See `AclNode::node()` for possible formats
 * @param array|CakeString|Model $aco ACO The controlled object identifier. See `AclNode::node()` for possible formats
