 ...
 *
 * @param CakeString $username The username/identifier.
 * @param CakeString $password Unused password, digest doesn't require passwords.
 ...
 *
 * @param CakeString $digest The raw digest authentication headers.
 ...
 * @param CakeString $password The digest hash password generated with DigestAuthenticate::password()
 * @return CakeString Response hash
 */
 ...
 *
 * @param CakeString $username The username to use in the digest hash.
 * @param CakeString $password The unhashed password to make a digest hash for.
 * @param CakeString $realm The realm the password is for.
 * @return CakeString the hashed password that can later be used with Digest authentication.
 */
 ...
 *
 * @return CakeString Headers for logging in.
 */
