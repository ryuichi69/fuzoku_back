 ...
 * @param CakeString $settings An array of settings.  This class does not use any settings.
 */
 ...
 * @param CakeString $path
 * @return CakeString the action path for the given request.
 */
