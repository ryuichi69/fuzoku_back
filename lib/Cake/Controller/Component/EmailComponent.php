 ...
 *
 * @param CakeString|array $content Either an array of text lines, or a string with contents
 *  If you are rendering a template this variable will be sent to the templates as `$content`
 * @param CakeString $template Template to use when sending email
 * @param CakeString $layout Layout to use to enclose email body
 ...
 *
 * @param CakeString $attachment Attachment file name to find
 * @return CakeString Path to located file
 */
 ...
 *
 * @param CakeString $value Value to strip
 * @param boolean $message Set to true to indicate main message content
 * @return CakeString Stripped value
 */
