 ...
 *
 * @param Controller $controller A reference to the controller
 * @param CakeString|array $url A string or array containing the redirect location
 ...
 *
 * @return CakeString Prototype version of component making Ajax call
 */
 ...
 * startup method.
 *
 * @param CakeString $name The name of the Content-type, i.e. "html", "xml", "css"
 * @param CakeString|array $type The Content-type or array of Content-types assigned to the name,
 ...
 *
 * @return CakeString Server address
 ...
 *
 * @param boolean $safe
 * @return CakeString Client IP address
 ...
 *
 * @param CakeString|array $type Can be null (or no parameter), a string type name, or an
 *   array of types
 ...
 *
 * @param CakeString|array $type Can be null (or no parameter), a string type name, or an array of types
 ...
 * HTTP_ACCEPT.
 *
 * @param CakeString|array $type An optional array of 'friendly' content-type names, i.e.
 *   'html', 'xml', 'js', etc.
 ...
 * @param CakeString $type Type of response to send (e.g: 'ajax')
 ...
 *
 * @param CakeString|array $type Friendly type name, i.e. 'html' or 'xml', or a full content-type,
 ...
 *
 * @param CakeString|array $cType Either a string content type to map, or an array of types.
 * @return CakeString|array Aliases for the types provided.
 ...
 *
 * @param CakeString|array $alias CakeString alias to convert back into a content type. Or an array of aliases to map.
 * @return CakeString Null on an undefined alias.  CakeString value of the mapped alias type.  If an
 ...
 *
 * @param CakeString $type The type alias being converted, ie. json
