 ...
 *
 * @param CakeString|array $action,... Controller action name or array of actions
 * @return void
 ...
 *
 * @return CakeString AuthComponent::$logoutRedirect
 ...
 *
 * @param CakeString $key field to retrieve.  Leave null to get entire User record
 ...
 *
 * @param CakeString|array $url Optional URL to write as the login redirect URL.
 * @return CakeString Redirect URL
 */
 ...
 *
 * @param CakeString $password Password to hash
 * @return CakeString Hashed password
 ...
 *
 * @param CakeString $message The message to set.
 * @return void
 */
