 ...
 *
 * @param CakeString $userAgent Set the userAgent
 * @return void
 */
 ...
 *
 * @param CakeString $name The name of the key your are setting in the session.
 * 							This should be in a Controller.key format for better organizing
 * @param CakeString $value The value you want to store in a session.
 ...
 *
 * @param CakeString $name the name of the session key you want to read
 ...
 *
 * @param CakeString $name the name of the session key you want to delete
 ...
 *
 * @param CakeString $name the name of the session key you want to check
 ...
 *
 * @return CakeString Last session error
 */
 ...
 *
 * @param CakeString $message Message to be flashed
 * @param CakeString $element Element to wrap flash message in.
 * @param array $params Parameters to be sent to layout as view variables
 * @param CakeString $key Message key, default is 'flash'
 * @return void
 ...
 *
 * @param CakeString $id Id to use (optional)
 * @return CakeString The current session id.
 */
