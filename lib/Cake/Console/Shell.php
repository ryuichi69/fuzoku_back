 ...
 *
 * @param CakeString $task The task name to check.
 ...
 *
 * @param CakeString $name The method name to check.
 * @return boolean
 ...
 *
 * @param CakeString $command The command name to run on this shell. If this argument is empty,
 ...
 * @return Shell CakeObject of Task
 */
 ...
 *
 * @param CakeString $prompt Prompt text.
 * @param CakeString|array $options Array or string of options.
 * @param CakeString $default Default input value.
 ...
 *
 * @param CakeString $text Text the text to format.
 * @param CakeString|integer|array $options Array of options to use, or an integer to wrap the text to.
 * @return CakeString Wrapped / indented text
 * @see CakeString::wrap()
 ...
 *
 * @param CakeString|array $message A string or a an array of strings to output
 ...
 *
 * @param CakeString $title Title of the error
 * @param CakeString $message An optional error message
 * @return void
 ...
 *
 * @param CakeString $path Where to put the file.
 * @param CakeString $contents Content to put in the file.
 * @return boolean Success
 ...
 *
 * @param CakeString $file Absolute file path
 * @return CakeString short path
 ...
 *
 * @param CakeString $name Controller class name
 * @return CakeString Path to controller
 */
 ...
 *
 * @param CakeString $name Controller class name
 * @return CakeString Controller plural name
 */
 ...
 *
 * @param CakeString $name Name
 * @return CakeString Camelized and singularized model name
 */
 ...
 *
 * @param CakeString $name Model class name
 * @return CakeString Singular model key
 */
 ...
 *
 * @param CakeString $key Foreign key
 * @return CakeString Model name
 */
 ...
 *
 * @param CakeString $name Name to use
 * @return CakeString Plural name for views
 */
 ...
 *
 * @param CakeString $name Controller name
 * @return CakeString Singular human name
 */
 ...
 *
 * @param CakeString $name Controller name
 * @return CakeString Plural human name
 */
 ...
 *
 * @param CakeString $pluginName Name of the plugin you want ie. DebugKit
 * @return CakeString $path path to the correct plugin.
 */
