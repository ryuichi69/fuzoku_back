 ...
 *
 * @param CakeString|array $name The long name of the option, or an array with all the properties.
 * @param CakeString $short The short alias for this option
 * @param CakeString $help The help text for this option
 * @param boolean $boolean Whether this option is a boolean option.  Boolean options don't consume extra tokens
 * @param CakeString $default The default value for this option.
 ...
 *
 * @return CakeString Value of this->_name.
 */
 ...
 *
 * @return CakeString Value of this->_short.
 */
