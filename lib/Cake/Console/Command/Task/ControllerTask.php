 ...
 *
 * @param CakeString $controllerName
 * @param CakeString $useDynamicScaffold
 * @param array $helpers
 ...
 *
 * @param CakeString $controllerName Controller name
 * @param CakeString $admin Admin route to use
 * @param boolean $wannaUseSession Set to true to use sessions, false otherwise
 * @return CakeString Baked actions
 */
 ...
 *
 * @param CakeString $controllerName Controller name already pluralized and correctly cased.
 * @param CakeString $actions Actions to add, or set the whole controller to use $scaffold (set $actions to 'scaffold')
 * @param array $helpers Helpers to use in controller
 * @param array $components Components to use in controller
 * @return CakeString Baked controller
 */
 ...
 *
 * @param CakeString $className Controller class name
 * @return CakeString Baked test
 */
 ...
 *
 * @param CakeString $prompt A yes/no question to precede the list
 * @param CakeString $example A question for a comma separated list, with examples.
 ...
 *
 * @param CakeString $useDbConfig Connection name to get a controller name for.
 * @return CakeString Controller name
 */
