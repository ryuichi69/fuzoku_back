 ...
 *
 * @param CakeString $domain
 * @param CakeString $msgid
 * @param array $details
 */
 ...
 */
	public function getOptionParser() {
		...
		return $parser->description(__d('cake_console', 'CakePHP Language CakeString Extraction:'))
 ...
 * Parse tokens
 *
 * @param CakeString $functionName Function name that indicates translatable string (e.g: '__')
 ...
 *
 * @param CakeString $field the name of the field that is being processed
 * @param array $rules the set of validation rules for the field
 * @param CakeString $file the file name where this validation rule was found
 * @param CakeString $domain default domain to bind the validations to
 * @return void
 */
 ...
 *
 * @param CakeString $domain
 * @param CakeString $header
 * @param CakeString $sentence
 * @return void
 */
 ...
 *
 * @return CakeString Translation template header
 */
 ...
 *
 * @param CakeString $string CakeString to format
 * @return CakeString Formatted string
 */
 ...
 *
 * @param CakeString $file File where invalid marker resides
 * @param integer $line Line number
 * @param CakeString $marker Marker found
