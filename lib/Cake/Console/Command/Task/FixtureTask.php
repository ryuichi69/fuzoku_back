 ...
 *
 * @param CakeString $modelName Name of model you are dealing with.
 ...
 *
 * @param CakeString $model Name of model to bake.
 * @param CakeString $useTable Name of table to use.
 * @param array $importOptions Options for public $import
 * @return CakeString Baked fixture content
 */
 ...
 *
 * @param CakeString $model name of the model being generated
 * @param CakeString $otherVars Contents of the fixture file.
 * @return CakeString Content saved into fixture file.
 */
 ...
 *
 * @return CakeString Path for the fixtures
 */
 ...
 * @return CakeString fields definitions
 */
...
/**
 * Generate CakeString representation of Records
 *
 * @param array $tableInfo Table schema array
 ...
 * @return CakeString A string value of the $records array.
 */
 ...
 * to build a fixture.
 *
 * @param CakeString $modelName name of the model to take records from.
 * @param CakeString $useTable Name of table to use.
