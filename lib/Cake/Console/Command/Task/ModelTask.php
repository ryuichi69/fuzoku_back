 ...
 *
 * @param CakeString $className Name of class you want model to be.
 * @param CakeString $table Table name
 ...
 * @param CakeString $prompt Prompt to use for options list.
 ...
 *
 * @param CakeString $modelName Name of the model relations belong to.
 * @param CakeString $type Name of association you want to see. i.e. 'belongsTo'
 * @param CakeString $associations Collection of associations.
 * @return void
 */
 ...
 * @return CakeString Name of field that is a primary key.
 */
 ...
 *
 * @param CakeString $fieldName Name of field to be validated.
 * @param array $metaData metadata for field
 * @param CakeString $primaryKey
 ...
 *
 * @param CakeString|CakeObject $name Model name or object
 ...
 *
 * @param CakeString $className Model class name
 * @return CakeString
 */
 ...
 *
 * @param CakeString $useDbConfig Database configuration name
 * @return array
 */
 ...
 *
 * @param CakeString $modelName Name of the model you want a table for.
 * @param CakeString $useDbConfig Name of the database config you want to get tables from.
 * @return CakeString Table name
 */
 ...
 *
 * @param CakeString $useDbConfig Connection name to scan.
 ...
 *
 * @param CakeString $useDbConfig Database config name
 * @return CakeString the model name
 */
 ...
 *
 * @param CakeString $className Name of class to bake fixture for
 * @param CakeString $useTable Optional table name for fixture to use.
 * @return void
