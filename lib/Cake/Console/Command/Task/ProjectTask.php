 ...
 *
 * @param CakeString $path Project path
 * @param CakeString $skel Path to copy from
 * @param CakeString $skip array of directories to skip when copying
 * @return mixed
 */
 ...
 *
 * @param CakeString $filename The filename to operate on.
 ...
 *
 * @param CakeString $name Name to use as admin routing
 * @return boolean Success
 */
 ...
 *
 * @return CakeString Admin route to use
 */
