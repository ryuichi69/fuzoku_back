 ...
 * Runs the template
 *
 * @param CakeString $directory directory / type of thing you want
 * @param CakeString $filename template name
 * @param array $vars Additional vars to set to template scope.
 * @return CakeString contents of generated code template
 */
 ...
 *
 * @return CakeString returns the path to the selected theme.
 */
 ...
 *
 * @param CakeString $path The initial path to look for the file on. If it is not found fallbacks will be used.
 * @param CakeString $directory Subdirectory to look for ie. 'views', 'objects'
 * @param CakeString $filename lower_case_underscored filename you want.
 * @return CakeString filename will exit program if template is not found.
 */
