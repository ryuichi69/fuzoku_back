 ...
 *
 * @param CakeString $action Action to bake
 * @param CakeString $content Content to write
 ...
 *
 * @param CakeString $action name to generate content to
 * @param array $vars passed for use in templates
 * @return CakeString content from template
 */
 ...
 *
 * @param CakeString $action name
 * @return CakeString template name
 */
