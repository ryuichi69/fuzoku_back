 ...
 *
 * @param CakeString $type Type of object to bake test case for ie. Model, Controller
 * @param CakeString $className the 'cake name' for the class ie. Posts for the PostsController
 * @return CakeString|boolean
 */
 ...
 *
 * @return CakeString Users chosen type.
 */
 ...
 *
 * @param CakeString $objectType Type of object to list classes for i.e. Model, Controller.
 * @return CakeString Class name the user chose.
 */
 ...
 *
 * @param CakeString $type The Type of object you are generating tests for eg. controller
 * @return boolean
 */
 ...
 *
 * @param CakeString $package The package of object you are generating tests for eg. controller
 * @param CakeString $class the Classname of the class the test is being generated for.
 * @return boolean
 */
 ...
 * @param CakeString $type The Type of object you are generating tests for eg. controller
 * @param CakeString $class the Classname of the class the test is being generated for.
 * @return CakeString Real classname
 */
 ...
 *
 * @param CakeString $type The type of thing having a test generated.
 * @param CakeString $plugin The plugin name.
 * @return CakeString
 ...
 *
 * @param CakeString $type The type the class having a test
 *   generated for is in.
 ...
 *
 * @param CakeString $className Name of class to look at.
 ...
 *
 * @param CakeString $name Name of the Model class that a fixture might be required for.
 * @return void
 */
 ...
 *
 * @param CakeString $type The type of object tests are being generated for eg. controller.
 * @return boolean
 */
 ...
 *
 * @param CakeString $type The Type of object you are generating tests for eg. controller
 * @param CakeString $fullClassName The Classname of the class the test is being generated for.
 * @param CakeString $plugin The plugin name.
 ...
 *
 * @param CakeString $type The Type of object you are generating tests for eg. controller
 * @param CakeString $realType The package name for the class.
 * @param CakeString $className The Classname of the class the test is being generated for.
 ...
 * @param CakeString $type The Type of object you are generating tests for eg. controller
 * @param CakeString $className the Classname of the class the test is being generated for.
 * @return CakeString filename the test should be created on.
 */
