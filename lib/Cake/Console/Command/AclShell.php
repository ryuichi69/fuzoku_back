 ...
 *
 * @param CakeString $class Class name that is being used.
 ...
 *
 * @param CakeString $identifier Identifier to parse
 ...
 *
 * @param CakeString $class Class type you want (Aro/Aco)
 * @param CakeString|array $identifier A mixed identifier for finding the node.
 ...
 *
 * @param CakeString $type Node type  (ARO/ACO)
