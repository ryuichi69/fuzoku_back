 ...
 */
/**
 * CakeObject wrapper for outputting information from a shell application.
 ...
 *
 * @param CakeString $stream The identifier of the stream to write output to.
 */
 ...
 *
 * @param CakeString $text Text with styling tags.
 * @return CakeString CakeString with color codes added.
 */
 ...
 *
 * @param CakeString $message Message to write.
 ...
 *
 * @param CakeString $style The style to get or create.
