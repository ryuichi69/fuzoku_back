 ...
 * Message ID
 *
 * @var boolean|CakeString True to generate, False to ignore, CakeString with value
 */
...
/**
 * Constructor
 * @param array|CakeString $config Array of configs, or string to load configs from email.php
 *
 */
 ...
 * To
 *
 * @param CakeString|array $email Null to get, CakeString with email, Array with email as key, name as value or email as value (without name)
 * @param CakeString $name
 * @return array|CakeEmail
 */
 ...
 * Add To
 *
 * @param CakeString|array $email CakeString with email, Array with email as key, name as value or email as value (without name)
 * @param CakeString $name
 ...
 *
 * @param CakeString $charset
 * @return CakeString $this->charset
 */
 ...
 * Get/Set Subject.
 *
 * @param CakeString $subject
 * @return CakeString|CakeEmail
 */
 ...
 * Template and layout
 *
 * @param boolean|CakeString $template Template name or null to not use
 * @param boolean|CakeString $layout Layout name or null to not use
 * @return array|CakeEmail
 */
 ...
 * Message-ID
 *
 * @param boolean|CakeString $message True to generate a new Message-ID, False to ignore (not send in email), CakeString to set as Message-ID
 * @return boolean|CakeString|CakeEmail
 * @throws SocketException
 */
 ...
 *
 * @param CakeString $domain Manually set the domain for CLI mailing
 * @return CakeString|CakeEmail
 */
 ...
 *
 * @param CakeString|array $attachments CakeString with the filename or array with filenames
 ...
 *
 * @param CakeString $type Use MESSAGE_* constants or null to return the full message as array
 * @return CakeString|array CakeString if have type, array if type is null
 */
 ...
 *
 * @param CakeString|array $config CakeString with configuration name (from email.php), array with config or null to return current config
 * @return CakeString|array|CakeEmail
 */
 ...
 * 
 * @param CakeString|array $content CakeString with message or array with messages
 * @return array
 * @throws SocketException
 */
 ...
 *
 * @param CakeString|array $to Address to send (see CakeEmail::to()). If null, will try to use 'to' from transport config
 * @param CakeString $subject CakeString of subject or null to use 'subject' from transport config
 * @param CakeString|array $message CakeString with message or array with variables to be used in render
 * @param CakeString|array $transportConfig CakeString to use config from EmailConfig or array with configs
 ...
 *
 * @param CakeString $text CakeString to encode
 * @return CakeString Encoded string
 */
 ...
 *
 * @param CakeString $text The text to be converted
 * @param CakeString $charset the target encoding
 * @return CakeString
 */
 ...
 *
 * @param CakeString $message Message to wrap
 ...
 *
 * @param CakeString $boundary Boundary to use. If null, will default to $this->_boundary
 ...
 *
 * @param CakeString $file The file to read.
 * @return CakeString File contents in base64 encoding
 */
 ...
 *
 * @param CakeString $content Content to render
 ...
 *
 * @param CakeString $content The content passed in from send() in most cases.
