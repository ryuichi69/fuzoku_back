 ...
 *
 * @param CakeString $name the header name
 * @param CakeString $value the header value
 * @return void
 */
 ...
 *
 * @param CakeString $content string to send as response body
 * @return void
 */
 ...
 *
 * @param CakeString|array $header. An array of header strings or a single header string
 ...
 *
 * @param CakeString $content the string message to be sent
 * @return CakeString current message buffer if $content param is passed as null
 */
 ...
 *
 * @param CakeString $alias the content type alias to map
 ...
 * @return CakeString current charset
 */
 ...
 *
 * @param CakeString $since a valid time since the response text has not been modified
 * @param CakeString $time a valid time for cache expiry
 * @return void
 */
 ...
 *
 * @param CakeString|DateTime $time
 * @return CakeString
 */
 ...
 * value is returned
 *
 * @param CakeString|array $cacheVariances a single Vary string or a array
 ...
 *
 * @param CakeString $hash the unique has that identifies this resposnse
 ...
 * as timezone
 *
 * @param CakeString|integer|DateTime $time
 * @return DateTime
 */
 ...
 *
 * @param CakeString $filename the name of the file as the browser will download the response
 * @return void
 */
 ...
 *
 * @return CakeString protocol to be used for sending response
 */
...
/**
 * CakeString conversion.  Fetches the response body as a string.
