 ...
 *
 * @param CakeString $name Header name
 * @param array $headers
 * @return mixed CakeString if header exists or null
 */
 ...
 *
 * @param CakeString $message Message to parse
 * @return void
 ...
 *
 * @param CakeString $body A string containing the body to decode.
 * @param CakeString|boolean $encoding Can be false in case no encoding is being used, or a string representing the encoding.
 ...
 * a result.
 *
 * @param CakeString $body A string containing the chunked body to decode.
 * @return mixed Array of response headers and body or false.
 * @throws SocketException
 */
 ...
 *
 * @param CakeString $token Token to unescape
 * @param array $chars
 * @return CakeString Unescaped token
