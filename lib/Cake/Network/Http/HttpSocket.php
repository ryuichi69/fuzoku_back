 ...
 * CakeObject Oriented replacement for cURL in many places.
 *
 * @package       Cake.Network.Http
 */
 ...
 *
 * @param CakeString|array $config Configuration information, either a string url or an array of options.
 */
 ...
 * `$http->configAuth();`
 *
 * @param CakeString $method Authentication method (ie. Basic, Digest). If empty, disable authentication
 * @param CakeString|array $user Username for authentication. Can be an array with settings to authentication class
 * @param CakeString $pass Password for authentication
 * @return void
 */
 ...
 * Set proxy settings
 *
 * @param CakeString|array $host Proxy host. Can be an array with settings to authentication class
 * @param integer $port Port. Default 3128.
 * @param CakeString $method Proxy method (ie, Basic, Digest). If empty, disable proxy authentication
 * @param CakeString $user Username if your proxy need authentication
 * @param CakeString $pass Password to proxy authentication
 * @return void
 */
 ...
 *
 * @param CakeString|array $request Either an URI string, or an array defining host/uri
 ...
 * }}}
 *
 * @param CakeString|array $uri URI to request. Either a string uri, or a uri array, see HttpSocket::_parseUri()
 ...
 * }}}
 *
 * @param CakeString|array $uri URI to request. See HttpSocket::_parseUri()
 ...
 *
 * @param CakeString|array $uri URI to request (see {@link _parseUri()})
 ...
 *
 * @param CakeString|array Either a string or array of url options to create a url with.
 * @param CakeString $uriTemplate A template string to use for url formatting.
 ...
 *
 * @param CakeString|array $uri URI, See HttpSocket::_parseUri()
 ...
 *
 * @param CakeString|array $uri Either A $uri array, or a request string. Will use $this->config if left empty.
 * @param CakeString $uriTemplate The Uri template/format to use.
 ...
 *
 * @param CakeString|array $uri URI to parse
 ...
 *
 * @param CakeString|array $query A query string to parse into an array or an array to return directly "as is"
 ...
 * @param CakeString $versionToken The version token to use, defaults to HTTP/1.1
 * @return CakeString Request line
 * @throws SocketException
 */
 ...
 * @param CakeString $mode
 * @return CakeString Header built from array
 */
 ...
 * @return CakeString Cookie header string to be sent with the request.
 ...
 *
 * @param CakeString $token Token to escape
 * @param array $chars
 * @return CakeString Escaped token
