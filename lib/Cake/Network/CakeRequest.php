 ...
 *
 * Has both an Array and CakeObject interface. You can access framework parameters using indexes:
 *
 ...
 * Constructor
 *
 * @param CakeString $url Trimmed url string to use.  Should not contain the application base path.
 ...
 *
 * @return CakeString URI The CakePHP request path that is being accessed.
 */
 ...
 *
 * @param CakeString $path The dot separated path to insert $data into.
 * @param array $data The data to traverse/insert.
 * @param CakeString $field The terminal field name, which is the top level key in $_FILES.
 * @return void
 */
 ...
 * @return CakeString The client IP.
 */
 ...
 * @return CakeString The referring address for this request.
 */
 ...
 *
 * @param CakeString $name The method called
 ...
 *
 * @param CakeString $name The property being accessed.
 ...
 *
 * @param CakeString $type The type of request you want to check.
 ...
 *
 * @param CakeString $name The name of the detector.
 ...
 * @return CakeString the current request url including query string args.
 */
 ...
 *
 * @param CakeString $name Name of the header you want.
 ...
 *
 * @return CakeString The name of the HTTP method used.
 */
 ...
 * @return CakeString Domain name without subdomains.
 */
 ...
 * by the client.
 *
 * @param CakeString $type The content type to check for.  Leave null to get all types a client accepts.
 ...
 *
 * @param CakeString $language The language to test.
 ...
 *
 * @param CakeString $name,... Dot separated name of the value to read/write
 ...
 *
 * @param CakeString $callback A decoding callback that will convert the string data to another
 ...
 *
 * @return CakeString contents of php://input
 */
 ...
 *
 * @param CakeString $name Name of the key being accessed.
 * @return mixed
 */
 ...
 *
 * @param CakeString $name Name of the key being written
 ...
 *
 * @param CakeString $name thing to check.
 * @return boolean
 */
 ...
 *
 * @param CakeString $name Name to unset.
 * @return void
 */
