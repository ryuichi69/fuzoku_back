 ...
 *
 * @param CakeString $type type of path
 * @param CakeString $plugin name of plugin
 * @return array
 ...
 * @param boolean|CakeString $mode App::RESET will set paths, App::APPEND with append paths, App::PREPEND will prepend paths (default)
 ...
 *
 * @param CakeString $plugin CamelCased/lower_cased plugin name to find the path of.
 * @return CakeString full path to the plugin.
 ...
 *
 * @param CakeString $theme theme name to find the path of.
 * @return CakeString full path to the theme.
 ...
 *
 * @param CakeString $type Type of object, i.e. 'Model', 'Controller', 'View/Helper', 'file', 'class' or 'plugin'
 * @param CakeString|array $path Optional Scan only the path given. If null, paths for the chosen type will be used.
 ...
 *
 * @param CakeString $className the name of the class to configure package for
 * @param CakeString $location the package name
 * @return void
 ...
 *
 * @param CakeString $className the name of the class to load
 * @return boolean
 */
 ...
 *
 * @param CakeString $className name of the class to obtain the package name from
 * @return CakeString package name or null if not declared
 ...
 * @param CakeString|array $type The type of Class if passed as a string, or all params can be passed as
 *                    an single array to $type,
 * @param CakeString $name Name of the Class or a unique name for the file
 ...
 * @param CakeString $file full name of the file to search for including extension
 ...
 *
 * @param CakeString $name unique name of the file for identifying it inside the application
 * @param CakeString $plugin camel cased plugin name if any
 * @param CakeString $type name of the packed where the class is located
 * @param CakeString $originalType type name as supplied initially by the user
 ...
 * @param CakeString $file filename if known, the $name param will be used otherwise
 ...
 * @param CakeString $name unique name of the file for identifying it inside the application
 * @param CakeString $plugin camel cased plugin name if any
 * @param CakeString $file file name if known
 * @param CakeString $ext file extension if known
 ...
 *
 * @param CakeString $file full path to file
 * @param CakeString $name unique name for this map
 * @param CakeString $plugin camelized if object is from a plugin, the name of the plugin
 * @return void
 */
 ...
 *
 * @param CakeString $name unique name
 * @param CakeString $plugin camelized if object is from a plugin, the name of the plugin
