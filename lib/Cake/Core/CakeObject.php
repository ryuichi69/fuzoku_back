 ...
 *
 * @return CakeString The name of this class
 */
 ...
 *
 * @param CakeString|array $url CakeString or array-based url.  Unlike other url arrays in CakePHP, this
 ...
 *
 * @param CakeString $method  Name of the method to call
 ...
 * testing easier.
 *
 * @param integer|CakeString $status see http://php.net/exit for values
 * @return void
 */
 ...
 *
 * @param CakeString $msg Log message
 ...
 * @param CakeString $class The class to merge the property with.
