 ...
 *
 * @param CakeString|array $plugin name of the plugin to be loaded in CamelCase format or array or plugins to load
 ...
 *
 * @param CakeString $plugin name of the plugin in CamelCase format
 * @return CakeString path to the plugin folder
 ...
 *
 * @param CakeString $plugin name of the plugin
 * @return mixed
 ...
 *
 * @param CakeString $plugin name of the plugin, if null will operate on all plugins having enabled the
 ...
 *
 * @param CakeString $plugin name of the plugin to forget
 * @return void
 */
