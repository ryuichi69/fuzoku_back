 ...
 */
	public static function bootstrap($boot = true) {
		if ($boot) {
			...
			// Preload Debugger + CakeString in case of E_STRICT errors when loading files.
 ...
 * @param CakeString $var Variable to obtain.  Use '.' to access array elements.
 ...
 * @param CakeString $var the var to be deleted
 * @return void
 */
 ...
 *
 * @param CakeString $name The name of the reader being configured.  This alias is used later to
 ...
 *
 * @param CakeString $name Name of the reader to drop.
 ...
 * @param CakeString $key name of configuration resource to load.
 * @param CakeString $config Name of the configured reader to use to read the resource identified by $key.
 ...
 *
 * @param CakeString $key The identifier to create in the config adapter.
 *   This could be a filename or a cache key depending on the adapter being used.
 * @param CakeString $config The name of the configured adapter to dump data with.
 ...
 *
 * @param CakeString $config The name of the configured adapter
 ...
 *
 * @return CakeString Current version of CakePHP
 */
 ...
 *
 * @param CakeString $name The storage name for the saved configuration.
 * @param CakeString $cacheConfig The cache configuration to save into.  Defaults to 'default'
 ...
 *
 * @param CakeString $name Name of the stored config file to load.
 * @param CakeString $cacheConfig Name of the Cache configuration to read from.
 * @return boolean Success.
 */
