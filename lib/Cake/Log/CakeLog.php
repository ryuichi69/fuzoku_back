 ...
 *
 * @param CakeString $key The keyname for this logger, used to remove the
 *    logger later.
 ...
 *
 * @param CakeString $streamName Key name of a configured stream to remove.
 * @return void
 */
 ...
 *
 * @param CakeString $streamName to check
 * @return bool
 * @throws CakeLogException
 */
 ...
 *
 * @param CakeString $streamName to enable
 * @return void
 * @throws CakeLogException
 */
 ...
 * its re-enabled.
 *
 * @param CakeString $streamName to disable
 * @return void
 * @throws CakeLogException
 */
 ...
 *
 * @param CakeString $streamName Key name of a configured stream to get.
 ...
 *
 * @param integer|CakeString $type Type of message being written. When value is an integer
 *    or a string matching the recognized levels, then it will
 *    be treated log levels. Otherwise it's treated as scope.
 * @param CakeString $message Message content to log
 * @param CakeString|array $scope The scope(s) a log message is being created in.
 ...
 *
 * @param CakeString $message log message
 * @param CakeString|array $scope The scope(s) a log message is being created in.
 *    See CakeLog::config() for more information on logging scopes.
 * @return boolean Success
 */
