 ...
 * @param CakeString $message Validation message explaining why the rule failed, defaults to true.
 * @return void
 */
 ...
 *
 * @param CakeString $name [optional] The fieldname to fetch. Defaults to null.
 ...
 *
 * @param CakeString $validationDomain [optional] The validation domain to be used.
 ...
 *
 * @param CakeString $field name of the field to check
 * @return boolean
 **/
 ...
 *
 * @param CakeString $field name of the field to set
 ...
 *
 * @param CakeString $field name of the field to unset
 * @return void
 **/
 ...
 * }}}
 *
 * @param CakeString $field The name of the field from wich the rule will be removed
 * @param CakeString|array|CakeValidationSet $name name of the rule to be added or list of rules for the field
 ...
 *
 * @param CakeString $field The name of the field from wich the rule will be removed
 * @param CakeString $rule the name of the rule to be removed
 * @return ModelValidator this instance
 **/
