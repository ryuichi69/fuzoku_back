 ...
 *
 * @param CakeString $table Table name you want returned.
 * @param array $fields Array of field information to generate the table with.
 * @return CakeString Variable declaration for a schema class
 */
...
/**
 * Formats Schema columns from Model CakeObject
 *
 ...
 *
 * @param CakeString $prefix Table prefix
 * @param CakeString $table Full table name
 * @return CakeString Prefix-less table name
 */
