 ...
 *
 * - `rule`: CakeString with method name, regular expression (started by slash) or array with method and parameters
 * - `message`: CakeString with the message or array if have multiple parameters. See http://php.net/sprintf
 ...
 *
 * @param integer|CakeString|array $id Set this ID for this model on startup, can also be an array of options, see above.
 * @param CakeString $table Name of database table to use.
 * @param CakeString $ds DataSource connection name.
 */
 ...
 *
 * @param CakeString $method Name of method to call.
 ...
 *
 * @param CakeString $name variable tested for existence in class
 ...
 *
 * @param CakeString $name variable requested for it's value or reference
 ...
 *
 * @param CakeString $assoc Association name
 * @param CakeString $className Class name
 * @param CakeString $plugin name of the plugin where $className is located
 ...
 *
 * @param CakeString $type 'belongsTo', 'hasOne', 'hasMany', 'hasAndBelongsToMany'
 * @param CakeString $assocKey
 * @return void
 */
 ...
 *
 * @param CakeString $tableName Name of the custom table
 * @return void
 ...
 *
 * @param CakeString|array|SimpleXmlElement|DomNode $one Array or string of data
 * @param CakeString $two Value string for the alternative indata method
 ...
 *
 * @param CakeString $field The name of the field to be deconstructed
 ...
 *
 * @param boolean|CakeString $field Set to true to reload schema, or a string to return a specific field
 ...
 *
 * @param CakeString $column The name of the model column
 * @return CakeString Column type
 */
 ...
 *
 * @param CakeString|array $name Name of field to look for, or an array of names
 ...
 *
 * @param CakeString $method The method to be called.
 ...
 *
 * @param CakeString $field Name of field to look for
 ...
 *
 * @param CakeString|array $fields CakeString of single field name, or an array of field names.
 * @param integer|CakeString $id The ID of the record to read
 ...
 * supplied order.
 *
 * @param CakeString $name Name of field to get
 * @param array $conditions SQL conditions (defaults to NULL)
 * @param CakeString $order SQL ORDER BY fragment
 * @return CakeString field contents, or false if not found
 ...
 * model ID.
 *
 * @param CakeString $name Name of the table field
 ...
 * @param integer|CakeString $id ID of record in this model
 * @param DataSource $db
 * @return void
 */
 ...
 *
 * @param integer|CakeString $id ID of record to delete
 ...
 *
 * @param CakeString $id ID of record that was deleted
 * @param boolean $cascade Set to true to delete records that depend on this record
 * @return void
 */
 ...
 *
 * @param integer|CakeString $id ID of record to check for existence
 ...
 * @param CakeString $type Type of find operation (all / first / count / neighbors / list / threaded)
 ...
 *
 * @param CakeString $state Either "before" or "after"
 * @param array $query
 * @param array $results
 * @return array
 * @see Model::find()
 ...
 *
 * @param CakeString $options An optional array of custom options to be made available in the beforeValidate callback
 ...
 *
 * @param CakeString $field The name of the field to invalidate
 ...
 *
 * @param CakeString $field Returns true if the input string ends in "_id"
 ...
 *
 * @param CakeString $field Field to escape (e.g: id)
 * @param CakeString $alias Alias for the model (e.g: Post)
 * @return CakeString The name of the escaped field for this Model (i.e. id becomes `Post`.`id`).
 */
 ...
 *
 * @param integer|CakeString $id Last inserted ID
 * @return void
 */
 ...
 *
 * @param CakeString $dataSource The name of the DataSource, as defined in app/Config/database.php
 * @return void
 ...
 *
 * @param CakeString $type Only result associations of this type
 ...
 *
 * @param CakeString|array $assoc The model to be joined
 ...
 *
 * @param CakeString $type If null this deletes cached views if Cache.check is true
