 ...
 * Constructor
 *
 * @param CakeString $fieldName The fieldname
 * @param array $ruleset
 */
 ...
 *
 * @param CakeString $validationDomain The validation domain to be used.
 * @return void
 */
 ...
 * }}}
 *
 * @param CakeString $name The name under which the rule should be set
 ...
 * }}}
 *
 * @param CakeString $name The name under which the rule should be unset
 * @return CakeValidationSet this instance
 */
 ...
 *
 * @param CakeString $name the name of the rule as it was configured
 ...
 *
 * @param CakeString $index name of the rule
 * @return boolean
 **/
