 ...
 *
 * @param CakeString $name The name of the DataSource, as defined in app/Config/database.php
 ...
 * @return CakeString Datasource name, or null if source is not present
 ...
 *
 * @param CakeString|array $connName A string name of the connection, as defined in app/Config/database.php,
 ...
 *
 * @param CakeString $name The DataSource name
 ...
 *
 * @param CakeString $name the connection name as it was created
 ...
 *
 * @param CakeString $name Connection name
 * @return void
 * @throws MissingDatasourceConfigException
 */
