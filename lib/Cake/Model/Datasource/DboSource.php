...
/**
 * CakeString to hold how many rows were affected by the last SQL operation.
 *
 * @var CakeString
 */
 ...
 *
 * @return CakeString The database version
 */
 ...
 *
 * @param CakeString $data CakeString to be prepared for use in an SQL statement
 * @param CakeString $column The column into which this data will be inserted
 * @return CakeString Quoted and escaped data
 */
 ...
 *
 * @param CakeString $identifier A SQL expression to be used as an identifier
 ...
 * are not sanitized or escaped.
 *
 * @param CakeString $expression An arbitrary SQL expression to be inserted into a query.
 ...
 *
 * @param CakeString $sql SQL statement
 ...
 * @return CakeString Error message with error number
 */
 ...
 *
 * @param CakeString $sql Some SQL to be executed.
 ...
 *
 * @param CakeString $name Name of the field
 * @param CakeString $sql SQL query
 ...
 *
 * @param CakeString $method Name of the method being cached.
 * @param CakeString $key The key name for the cache operation.
 ...
 *
 * @param Model|CakeString $model Either a Model object or a string table name.
 * @param boolean $quote Whether you want the table name quoted.
 * @param boolean $schema Whether you want the schema name included.
 * @return CakeString Full quoted table name
 */
 ...
 * @param CakeString $type Association type, one of the model association types ie. hasMany
 * @param CakeString $association
 ...
 *
 * @param Model $model Primary model object
 * @param CakeString $query Association query
 ...
 * @param CakeString $association Name of Model being Merged
 ...
 *
 * @param CakeString $type Association type
 * @param Model $model Model object
 * @param CakeString $linkModel
 * @param CakeString $alias
 * @param array $assoc
 * @param CakeString $alias2
 ...
 * @return CakeString An SQL JOIN statement to be used in a query
 ...
 * @return CakeString An executable SQL statement
 ...
 *
 * @param CakeString $type type of query being run.  e.g select, create, update, delete, schema, alter.
 * @param array $data Array of data to insert into the query.
 * @return CakeString Rendered SQL expression to be run.
 */
 ...
 *
 * @param Model $model
 * @param CakeString $func Lowercase name of SQL function, i.e. 'count' or 'max'
 * @param array $params Function parameters (any values must be quoted manually)
 * @return CakeString An SQL calculation function
 */
 ...
 *
 * @param Model|CakeString $table A string or model class representing the table to be truncated
 ...
 *
 * @param Model $model
 * @param CakeString|array|boolean $conditions Array of conditions, conditions string, null or false. If an array of conditions,
 ...
 *
 * @param Model $model
 * @param CakeString $key
 * @param CakeString $assoc
 * @return CakeString
 */
 ...
 *
 * @param Model $model
 * @param CakeString $alias Alias table name
 ...
 * @return CakeString SQL fragment
 */
 ...
 * @param CakeString $key An SQL key snippet containing a field and optional SQL operator
 ...
 * Quotes Model.fields
 *
 * @param CakeString $conditions
 * @return CakeString or false if no match
 */
 ...
 *
 * @param CakeString $match matched string
 * @return CakeString quoted string
 */
 ...
 * @return CakeString SQL limit/offset statement
 */
 ...
 *
 * @param array|CakeString $keys Field reference, as a key (i.e. Post.title)
 * @param CakeString $direction Direction (ASC or DESC)
 * @param Model $model model reference (used to look for virtual field)
 * @return CakeString ORDER BY clause
 */
 ...
 *
 * @param CakeString $group Group By Condition
 * @param Model $model
 * @return CakeString string condition or null
 */
 ...
 * @param CakeString $sql SQL WHERE clause (condition only, not the "WHERE" part)
 ...
 *
 * @param CakeString $real Real database-layer column type (i.e. "varchar(255)")
 ...
 * @param boolean $quote
 * @return CakeString|boolean Converted boolean value
 */
 ...
 *
 * @param CakeString $table The table being inserted into.
 ...
 *
 * @param CakeString $model Name of model to inspect
 ...
 * @param CakeString $tableName Optional.  If specified only the table name given will be generated.
 ...
 * @param CakeString $table Optional.  If specified only the table name given will be generated.
 *   Otherwise, all tables defined in the schema are generated.
 * @return CakeString
 */
 ...
 *
 * @param CakeString $columnString The partially built column string
 * @param array $columnData The array of column data.
 * @param CakeString $position The position type to use. 'beforeDefault' or 'afterDefault' are common
 * @return CakeString a built column with the field parameters added.
 */
