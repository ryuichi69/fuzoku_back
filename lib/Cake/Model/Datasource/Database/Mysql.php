 ...
 *
 * @param CakeString $name Collation name
 * @return CakeString Character set name
 */
 ...
 *
 * @param Model|CakeString $model Name of database table to inspect or model instance
 ...
 *
 * @param CakeString $enc Database encoding
 * @return boolean
 */
 ...
 *
 * @param CakeString $table Table to alter parameters for.
 ...
 *
 * @param CakeString $name Table name to get parameters
 * @return array Array of table names in the database
 */
