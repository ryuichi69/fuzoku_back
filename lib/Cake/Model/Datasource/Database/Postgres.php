 ...
 *
 * @param Model|CakeString $model Name of database table to inspect
 ...
 *
 * @param CakeString $source Name of the database table
 * @param CakeString $field Name of the ID database field. Defaults to "id"
 * @return integer
 */
 ...
 *
 * @param CakeString|Model $table Either a full table name (with prefix) as a string, or a model object
 * @param CakeString $field Name of the ID database field. Defaults to "id"
 * @return CakeString The associated sequence name from the sequence map, defaults to "{$table}_{$field}_seq"
 */
 ...
 *
 * @param CakeString|Model $table A string or model class representing the table to be truncated
 ...
 * @param CakeString $table name of the table
 * @return array
 */
 ...
 *
 * @param CakeString $table Table to alter indexes for
 ...
 * @return CakeString Abstract column type (i.e. "string")
 */
 ...
 *
 * @return CakeString The database encoding
 */
 ...
 *
 * @return CakeString The schema name
 */
