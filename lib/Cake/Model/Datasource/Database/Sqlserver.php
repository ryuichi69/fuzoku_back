 ...
 *
 * @param Model|CakeString $model Model object to describe, or a string table name.
 ...
 *
 * @param CakeString $type Query type
 ...
 *
 * @param Model|CakeString $model Model instance of table name
 * @return CakeString
 */
