 ...
 *
 * @param CakeString $real Real  column type (i.e. "varchar(255)")
 ...
 *
 * @param CakeString $object The name of the object (model) to cache
 ...
 *
 * @param CakeString $query Query string needing replacements done.
 * @param array $data Array of data with values that will be inserted in placeholders.
 * @param CakeString $association Name of association model being replaced
 ...
 * @param array $stack
 * @return CakeString CakeString of query data with placeholders replaced.
 ...
 * @param CakeString $key Key name to make
 * @return CakeString Key name for model.
 */
