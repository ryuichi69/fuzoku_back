 ...
 * @param CakeString $sortby Sort by this key
 * @param CakeString $order  Sort order asc/desc (ascending or descending).
 ...
 *
 * @param CakeString|array|CakeObject $text Text to wrap through htmlspecialchars.  Also works with arrays, and objects.
 *    Arrays will be mapped and have all their elements escaped.  Objects will be string cast if they
 *    implement a `__toString` method.  Otherwise the class name will be used.
 * @param boolean $double Encode existing html entities
 * @param CakeString $charset Character set to use when escaping.  Defaults to config value in 'App.encoding' or 'UTF-8'
 * @return CakeString Wrapped text
 ...
 * @param CakeString $plugin Optional default plugin to use if no plugin is found. Defaults to null.
 ...
 *
 * @param  CakeString $key Environment variable name.
 * @return CakeString Environment variable setting.
 ...
 *
 * @param  CakeString $path	File path within /tmp to save the file.
 * @param  mixed  $data	The data to save to the temporary file.
 * @param  mixed  $expires A valid strtotime string when the data expires.
 * @param  CakeString $target  The target of the cached data; either 'cache' or 'public'.
 ...
 *
 * @param CakeString|array $params As CakeString name to be searched for deletion, if name is a directory all files in
 *   directory will be deleted. If array, names to be searched for deletion. If clearCache() without params,
 *   all files in app/tmp/cache/views will be deleted
 * @param CakeString $type Directory in tmp/cache defaults to view directory
 * @param CakeString $ext The file extension you are deleting
 ...
 *
 * @param CakeString $singular Text to translate
 ...
 *
 * @param CakeString $singular Singular text to translate
 * @param CakeString $plural Plural text
 ...
 *
 * @param CakeString $domain Domain
 * @param CakeString $msg CakeString to translate
 * @param mixed $args Array with arguments or multiple arguments in function
 ...
 *
 * @param CakeString $domain Domain
 * @param CakeString $singular Singular string to translate
 * @param CakeString $plural Plural
 * @param integer $count Count
 * @param mixed $args Array with arguments or multiple arguments in function
 ...
 *
 * @param CakeString $domain Domain
 * @param CakeString $msg Message to translate
 ...
 *
 * @param CakeString $message Message to write to log
 * @return void
 ...
 *
 * @param CakeString $file File to look for
 ...
 *
 * @param CakeString CakeString to convert
 * @return CakeString with underscore remove from start and end of string
