 ...
 *
 * @param CakeString $language Language (if null will use DEFAULT_LANGUAGE if defined)
 * @return mixed
 */
 ...
 *
 * @param CakeString|array $mixed 2/3 char string (language/locale), array of those strings, or null
 * @return CakeString|array|boolean string language/locale, array of those values, whole map as an array,
 ...
 *
 * @param CakeString|array $language string requested language, array of requested languages, or null for whole catalog
