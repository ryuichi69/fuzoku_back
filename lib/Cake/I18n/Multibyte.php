 ...
 *
 * @param CakeString $haystack The string from which to get the position of the first occurrence of $needle.
 * @param CakeString $needle The string to find in $haystack.
 * @param integer $offset The position in $haystack to start searching.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param CakeString $haystack The string from which to get the first occurrence of $needle.
 * @param CakeString $needle The string to find in $haystack.
 ...
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeString|boolean The portion of $haystack, or false if $needle is not found.
 */
 ...
 * Get string length.
 *
 * @param CakeString $string The string being checked for length.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param CakeString $haystack The string being checked.
 * @param CakeString $needle The position counted from the beginning of haystack.
 ...
 *
 * @param CakeString $haystack The string from which to get the last occurrence of $needle.
 * @param CakeString $needle The string to find in $haystack.
 * @param boolean $part Determines which portion of $haystack this function returns.
 ...
 *
 * @param CakeString $haystack The string from which to get the position of the last occurrence of $needle.
 * @param CakeString $needle The string to find in $haystack.
 * @param integer $offset The position in $haystack to start searching.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param CakeString $haystack The string being checked, for the last occurrence of $needle.
 * @param CakeString $needle The string to find in $haystack.
 ...
 *    Default value is FALSE.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeString|boolean The portion of $haystack, or true if $needle is not found.
 */
 ...
 *
 * @param CakeString $string The string being lowercased.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeString with all alphabetic characters converted to lowercase.
 */
 ...
 *
 * @param CakeString $string The string being uppercased.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeString with all alphabetic characters converted to uppercase.
 */
 ...
 *
 * @param CakeString $haystack The string being checked.
 * @param CakeString $needle The string being found.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 * Get part of string
 *
 * @param CakeString $string The string being checked.
 * @param integer $start The first position used in $string.
 * @param integer $length The maximum length of the returned string.
 * @param CakeString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return CakeString The portion of $string specified by the $string and $length parameters.
 */
 ...
 *
 * @param CakeString $str The string being encoded
 * @param CakeString $charset specifies the name of the character set in which str is represented in.
 *    The default value is determined by the current NLS setting (mbstring.language).
 * @param CakeString $transfer_encoding specifies the scheme of MIME encoding.
 *    It should be either "B" (Base64) or "Q" (Quoted-Printable). Falls back to "B" if not given.
 * @param CakeString $linefeed specifies the EOL (end-of-line) marker with which
 ...
 * @return CakeString A converted version of the string represented in ASCII.
 */
 ...
 *
 * @param CakeString $string value to encode
 * @param CakeString $charset charset to use for encoding. defaults to UTF-8
 * @param CakeString $newline
 * @return CakeString
 ...
 * @param CakeString $string value to test
 * @return boolean
 */
