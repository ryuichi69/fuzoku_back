 ...
 *
 * @param CakeString $singular CakeString to translate
 * @param CakeString $plural Plural string (if any)
 * @param CakeString $domain Domain The domain of the translation.  Domains are often used by plugin translations
 * @param CakeString $category Category The integer value of the category to use.
 * @param integer $count Count Count is used with $plural to choose the correct plural form.
 * @param CakeString $language Language to translate string to.
 * 	If null it checks for language in session followed by Config.language configuration variable.
 * @return CakeString translated string.
 */
 ...
 *
 * @param CakeString $domain Domain to bind
 * @return CakeString Domain binded
 */
 ...
 *
 * @param CakeString $filename Binary .mo file to load
 ...
 *
 * @param CakeString $filename Text .po file to load
 * @return mixed Array of translations on success or false on failure
 */
 ...
 *
 * @param CakeString $filename Locale definition filename
 ...
 *
 * @param CakeString $string Symbol to be parsed
 * @return CakeString parsed symbol
 */
 ...
 *
 * @param CakeString $format Format to be translated
 * @param CakeString $domain Domain where format is stored
